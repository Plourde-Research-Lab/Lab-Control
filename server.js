...
app.get('/status', function (req, res) {
    switch(req.query.fridge) {
        case 'ADR1': var dataDB = ADR1.control; break;
        case 'ADR2': var dataDB = ADR2.control; break;
        case 'DR1': var dataDB = DR1.data; break;
        case 'DR2': var dataDB = DR2.data; break;
    }
...
app.get('/getJobs', function (req, res) {
    switch(req.query.fridge) {
        case 'ADR1': var jobsDB = ADR1.job; break;
        case 'ADR2': var jobsDB = ADR2.job; break;
    }
...
app.get('/getData', function (req, res) {
    switch(req.query.fridge) {
        case 'DR1': var dataDB = DR1.data; break;
        case 'DR2': var dataDB = DR2.data; break;
        case 'ADR1': var dataDB = ADR1.data; break;
        case 'ADR2': var dataDB = ADR2.data; break;
    }
...
app.get('/history', function (req, res) {
    switch(req.query.fridge) {
        case 'DR1': var dataDB = DR1.history; break;
        case 'DR2': var dataDB = DR2.history; break;
        case 'ADR1': var dataDB = ADR1.history; break;
        case 'ADR2': var dataDB = ADR2.history; break;
    }
...
app.post('/history', function  (req, res) {
    switch(req.body.fridge) {
        case 'ADR1': var historyDB = ADR1.history; var dataDB = ADR1.data; break;
        case 'ADR2': var historyDB = ADR2.history; var dataDB = ADR2.data; break;
    }
